...
class JRubyzScheduleSpec extends AnyWordSpec with Matchers {
  ...
  "addInterval" should {
    "add an interval to an empty list" in {
      addInterval(Array(), TimeInterval("08:00", "12:00")) shouldEqual Array(TimeInterval("08:00", "12:00"))
    }

    "add a non overlapping interval" in {
      addInterval(Array(TimeInterval("14:00", "18:00")), TimeInterval("08:00", "12:00")) shouldEqual Array(
    ...
    "add an overlapping interval" in {
      addInterval(Array(TimeInterval("14:00", "18:00")), TimeInterval("08:00", "16:00")) shouldEqual Array(
